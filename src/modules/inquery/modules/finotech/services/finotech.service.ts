...
import { baseUrl, getBankCartDetailApi, convertCartToShebaApi, getShebaDetailApi, convertCardToBankAccountApi, convertBankAccountToShebaApi, facilityWithNationalCode, banksInfo, preRequestTokenSms, verifyRequestTokenSms, confirmRequestTokenSms, matchMobileNationalCode, nationalCodeMobile } from '../urls';
...
export class FinooService {
  ...
  async matchNationalCodeMobile(matchedMobileNationalCodeDto: MatchedMobileNationalCodeDto) {
    try {
      const requestParam: MatchedMobileNationalCodeDto = {
        mobile: matchedMobileNationalCodeDto.mobile,
        nationalCode: matchedMobileNationalCodeDto.nationalCode,
      ...
      const requestHeader = { Authorization: `Bearer ${this.reqToken.getToken}` }
      const request = await axios({ method: "GET", url: baseUrl + nationalCodeMobile, headers: requestHeader, params: requestParam })
      ...
      const matchMobileNationaCodeResponse: CreateMatchMobileNationalCodeDto = {
        isValid: requestData.result.isValid,
        status: requestData.status,
        trackId: requestData.trackId,
        mobile: matchedMobileNationalCodeDto.mobile,
        nationalCode: matchedMobileNationalCodeDto.nationalCode
