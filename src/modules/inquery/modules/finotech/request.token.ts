    ...
    async generateToken() {
        try {
            ...
            const requestBody =
            {
                ...
                nid: "0872912558",
                scopes:
                    `${APiScopesEnum.CARDDETAILS},${APiScopesEnum.CARDTODEPOSIT},${APiScopesEnum.CARDTOIBAN},${APiScopesEnum.DEPOSITTOIBAN},${APiScopesEnum.IBANINQUIRY},${APiScopesEnum.NATIONALCODEMOBILE}`
            }
